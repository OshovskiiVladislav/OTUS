...
class ShellCommentImplTest {
    ...
    private static final String COMMAND_PUBLISH_SAVE_COMMENT = "saveComment Good_book_1";
    ...
    private static final String COMMAND_PUBLISH_GET_COMMENT_BY_TEXT = "fct Good_book";

    private static final Long EXPECTED_COMMENTS_COUNT = 2L;
    private static final String NEW_COMMENT_TEXT = "Good_book_1";
    ...
    void publishCommentByID_validCommandAndCommentId_shouldReturnExpectedMessage(){
        ...
        // Call
        val actualComment = (CommentDto) shell.evaluate(()-> COMMAND_PUBLISH_GET_COMMENT_BY_ID);
    ...
    void saveComment_validCommandAndComment_shouldReturnExpectedMessage(){
        ...
        val expectedCommentDto = new CommentDto();
        expectedCommentDto.setText(NEW_COMMENT_TEXT);

        when(commentService.saveComment(NEW_COMMENT_TEXT)).thenReturn(expectedCommentDto);

        // Call
        val actualMessage = (CommentDto) shell.evaluate(()-> COMMAND_PUBLISH_SAVE_COMMENT);

        // Verify
        assertThat(actualMessage).isEqualTo(expectedCommentDto);
    ...
    void publishCommentByText_validCommandAndCommentText_shouldReturnExpectedCommentMessage() {
        ...
        // Call
        val actualCommentDtoMessage = (CommentDto) shell.evaluate(()-> COMMAND_PUBLISH_GET_COMMENT_BY_TEXT);

        // Verify
        assertThat(actualCommentDtoMessage).isEqualTo(expectedCommentDto);
