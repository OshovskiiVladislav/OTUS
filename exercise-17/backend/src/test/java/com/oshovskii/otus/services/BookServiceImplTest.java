...
class BookServiceImplTest {
    ...
    @Test
    void findAllBooks_expectedVoidInput_shouldReturnExpectedBooksList() {
        // Config
        // create 1 book
    ...
    @Test
    void findBookById_expectedValidBookId_shouldReturnExpectedBookById(){
        // Config
        val expectedBook = createBookWithAllInfoById(EXISTING_BOOK_ID);
        val expectedBookDto = createBookDtoWithAllInfoById(EXISTING_BOOK_ID);
    ...
    @Test
    void save_expectedValidBook_shouldSaveBook(){
        // Config;
    ...
    @Test
    void deleteBookById_expectedValidId_shouldCorrectDeleteBookById(){
        // Config
